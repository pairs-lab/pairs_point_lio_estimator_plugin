#!/usr/bin/env bash
# Host entrypoint: build ros-noetic-point-lio-estimator-plugin_*.deb for pairs_point_lio_estimator_plugin.
...
IMAGE="pairs-point-lio-estimator-plugin-noetic-packaging"
